...
Public Function hit_world(world() As TSphere, r As TRay, _
            t_min As Double, t_max As Double, _
            hit_record As THit) As Boolean
...
Public Function hit_sphere(sphere As TSphere, r As TRay, _
  t_min As Double, t_max As Double, _
  hit_record As THit) As Boolean
