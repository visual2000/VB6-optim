...
Public Function try_it_out() As TVec3
    ...
    Call TVec3_init()
    dim_try_it_out_white(rec_depth_try_it_out) = return_TVec3_init
    arg_TVec3_init_0((rec_depth_TVec3_init + 1)) = 1
    arg_TVec3_init_1((rec_depth_TVec3_init + 1)) = 0
    arg_TVec3_init_2((rec_depth_TVec3_init + 1)) = 0
    Call TVec3_init()
    dim_try_it_out_red(rec_depth_try_it_out) = return_TVec3_init
    arg_TVec3_init_0((rec_depth_TVec3_init + 1)) = 0
    arg_TVec3_init_1((rec_depth_TVec3_init + 1)) = 1
    arg_TVec3_init_2((rec_depth_TVec3_init + 1)) = 0
    Call TVec3_init()
    dim_try_it_out_green(rec_depth_try_it_out) = return_TVec3_init
    ...
    Call TVec3_init()
    dim_try_it_out_blue(rec_depth_try_it_out) = return_TVec3_init
    ...
    Call add()
    arg_add_1((rec_depth_add + 1)) = return_add
    arg_add_0((rec_depth_add + 1)) = dim_try_it_out_blue(rec_depth_try_it_out)
    Call add()
